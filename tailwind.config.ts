...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "emma-gradient": "var(--emma-gradient)",
        "emma-gradient-cool": "var(--emma-gradient-cool)",
        "emma-gradient-warm": "var(--emma-gradient-warm)",
        "emma-text-gradient": "var(--emma-text-gradient)",
        "emma-mesh": "var(--emma-mesh)",
      },
